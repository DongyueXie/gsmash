---
title: "sla data, ebpmf fit using alternative flash init"
author: "DongyueXie"
date: "2023-09-22"
...
The default initialization of EBPMF of mu (the ``latent'' data) and $\sigma^2$ is using VGA with mean 0 (after init of intercepts). However this initialization possibly leads to under-fitting, [as demonstrated here](https://stephens999.github.io/gsmash/01MS_ebpmf_residuals).
